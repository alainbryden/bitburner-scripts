...
## Updating helper classes

Helper classes are generated by using a script that includes required files. To update helper classes, please do not edit `helpers.js` direcly. Edit `helpers.src.js` instead.
To generate `helpers.js`, use
