...
export async function main(ns) {
    ...
    periodicScripts = [
        ...
        { interval: 33000, shortName: 'hacknet_8h', name: "hacknet-upgrade-manager.js", shouldRun: shouldUpgradeHacknet, args: () => ["-c", "--max-payoff-time", "8h", "--max-spend", ns.getServerMoneyAvailable("home") * 0.01] },
